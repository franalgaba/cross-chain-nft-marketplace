...
async def test_execute(account_factory):
    ...
    initializable = await starknet.deploy("contracts/security/initializable.cairo")
...
async def test_multicall(account_factory):
    starknet, account = account_factory
    initializable_1 = await starknet.deploy("contracts/security/initializable.cairo")
    initializable_2 = await starknet.deploy("contracts/security/initializable.cairo")
